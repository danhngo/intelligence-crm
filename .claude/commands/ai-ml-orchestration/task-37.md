# ai-ml-orchestration - Task 37

Execute task 37 for the ai-ml-orchestration specification.

## Task Description
Create JWT authentication middleware in app/core/auth.py

## Code Reuse
**Leverage existing code**: Existing JWT patterns, RBAC from User Management Service
...
## Usage
```
/Task:37-ai-ml-orchestration
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create JWT authentication middleware in app/core/auth.py"

```
Use the @spec-task-executor agent to implement task 37: "Create JWT authentication middleware in app/core/auth.py" for the ai-ml-orchestration specification and include all the below context.
...
## Task Details
- Task ID: 37
- Description: Create JWT authentication middleware in app/core/auth.py
- Leverage: Existing JWT patterns, RBAC from User Management Service
- Requirements: 7.1, 7.4

## Instructions
- Implement ONLY task 37: "Create JWT authentication middleware in app/core/auth.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ai-ml-orchestration 37 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ai-ml-orchestration 37 --mode complete
```
