# ai-ml-orchestration - Task 36

Execute task 36 for the ai-ml-orchestration specification.

## Task Description
Create communication service client in app/clients/communication_client.py

## Code Reuse
**Leverage existing code**: Existing service communication patterns
...
## Usage
```
/Task:36-ai-ml-orchestration
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create communication service client in app/clients/communication_client.py"

```
Use the @spec-task-executor agent to implement task 36: "Create communication service client in app/clients/communication_client.py" for the ai-ml-orchestration specification and include all the below context.
...
## Task Details
- Task ID: 36
- Description: Create communication service client in app/clients/communication_client.py
- Leverage: Existing service communication patterns
- Requirements: 3.4, 4.5

## Instructions
- Implement ONLY task 36: "Create communication service client in app/clients/communication_client.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ai-ml-orchestration 36 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ai-ml-orchestration 36 --mode complete
```
