# crm-core-services - Task 28

Execute task 28 for the crm-core-services specification.

## Task Description
Add contact search functionality to Contact repository

## Code Reuse
**Leverage existing code**: PostgreSQL full-text search, search ranking algorithms
...
## Usage
```
/Task:28-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add contact search functionality to Contact repository"

```
Use the @spec-task-executor agent to implement task 28: "Add contact search functionality to Contact repository" for the crm-core-services specification and include all the below context.
...
## Task Details
- Task ID: 28
- Description: Add contact search functionality to Contact repository
- Leverage: PostgreSQL full-text search, search ranking algorithms
- Requirements: 3.2

## Instructions
- Implement ONLY task 28: "Add contact search functionality to Contact repository"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 28 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 28 --mode complete
```
