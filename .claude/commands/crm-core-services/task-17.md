# crm-core-services - Task 17

Execute task 17 for the crm-core-services specification.

## Task Description
Create leads table migration for CRM Management Service

## Code Reuse
**Leverage existing code**: PostgreSQL JSONB, status-based indexes
...
## Usage
```
/Task:17-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create leads table migration for CRM Management Service"

```
Use the @spec-task-executor agent to implement task 17: "Create leads table migration for CRM Management Service" for the crm-core-services specification and include all the below context.
...
## Task Details
- Task ID: 17
- Description: Create leads table migration for CRM Management Service
- Leverage: PostgreSQL JSONB, status-based indexes
- Requirements: 5.1, 5.2, 6.1

## Instructions
- Implement ONLY task 17: "Create leads table migration for CRM Management Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 17 --mode complete
```
