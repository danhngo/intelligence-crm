# crm-core-services - Task 65

Execute task 65 for the crm-core-services specification.

## Task Description
Create Kubernetes deployment for CRM Management Service
...
## Usage
```
/Task:65-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Kubernetes deployment for CRM Management Service"

```
Use the @spec-task-executor agent to implement task 65: "Create Kubernetes deployment for CRM Management Service" for the crm-core-services specification and include all the below context.
...
## Task Details
- Task ID: 65
- Description: Create Kubernetes deployment for CRM Management Service
- Leverage: Kubernetes Deployment patterns
- Requirements: Scalability, reliability

## Instructions
- Implement ONLY task 65: "Create Kubernetes deployment for CRM Management Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 65 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 65 --mode complete
```
