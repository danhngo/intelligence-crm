# crm-core-services - Task 22

Execute task 22 for the crm-core-services specification.

## Task Description
Create tenant isolation validator in both services

## Code Reuse
**Leverage existing code**: GORM scopes, security violation detection
...
## Usage
```
/Task:22-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create tenant isolation validator in both services"

```
Use the @spec-task-executor agent to implement task 22: "Create tenant isolation validator in both services" for the crm-core-services specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Create tenant isolation validator in both services
- Leverage: GORM scopes, security violation detection
- Requirements: 6.2, 6.3

## Instructions
- Implement ONLY task 22: "Create tenant isolation validator in both services"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 22 --mode complete
```
