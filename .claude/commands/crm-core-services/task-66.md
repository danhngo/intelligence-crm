# crm-core-services - Task 66

Execute task 66 for the crm-core-services specification.

## Task Description
Create Kubernetes Service for CRM Management Service
...
## Usage
```
/Task:66-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Kubernetes Service for CRM Management Service"

```
Use the @spec-task-executor agent to implement task 66: "Create Kubernetes Service for CRM Management Service" for the crm-core-services specification and include all the below context.
...
## Task Details
- Task ID: 66
- Description: Create Kubernetes Service for CRM Management Service
- Leverage: Kubernetes Service patterns
- Requirements: Scalability

## Instructions
- Implement ONLY task 66: "Create Kubernetes Service for CRM Management Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 66 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 66 --mode complete
```
