# crm-core-services - Task 72

Execute task 72 for the crm-core-services specification.

## Task Description
Add health check endpoints to both services

## Code Reuse
**Leverage existing code**: Health check patterns, dependency validation

## Requirements Reference
**Requirements**: Reliability, deployment automation

## Usage
```
/Task:72-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add health check endpoints to both services"

```
Use the @spec-task-executor agent to implement task 72: "Add health check endpoints to both services" for the crm-core-services specification and include all the below context.
...
## Task Details
- Task ID: 72
- Description: Add health check endpoints to both services
- Leverage: Health check patterns, dependency validation
- Requirements: Reliability, deployment automation

## Instructions
- Implement ONLY task 72: "Add health check endpoints to both services"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 72 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 72 --mode complete
```
