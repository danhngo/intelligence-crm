# crm-core-services - Task 10

Execute task 10 for the crm-core-services specification.

## Task Description
Create users table migration for User Management Service

## Code Reuse
**Leverage existing code**: PostgreSQL UUID functions, composite indexes
...
## Usage
```
/Task:10-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create users table migration for User Management Service"

```
Use the @spec-task-executor agent to implement task 10: "Create users table migration for User Management Service" for the crm-core-services specification and include all the below context.
...
## Task Details
- Task ID: 10
- Description: Create users table migration for User Management Service
- Leverage: PostgreSQL UUID functions, composite indexes
- Requirements: 1.1, 6.1

## Instructions
- Implement ONLY task 10: "Create users table migration for User Management Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 10 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 10 --mode complete
```
