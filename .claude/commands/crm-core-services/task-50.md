# crm-core-services - Task 50

Execute task 50 for the crm-core-services specification.

## Task Description
Create middleware package for CRM Management Service

## Code Reuse
**Leverage existing code**: gRPC client, tenant context, request middleware

## Requirements Reference
**Requirements**: 2.2, 6.2, 7.4

## Usage
```
/Task:50-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create middleware package for CRM Management Service"

```
Use the @spec-task-executor agent to implement task 50: "Create middleware package for CRM Management Service" for the crm-core-services specification and include all the below context.
...
## Task Details
- Task ID: 50
- Description: Create middleware package for CRM Management Service
- Leverage: gRPC client, tenant context, request middleware
- Requirements: 2.2, 6.2, 7.4

## Instructions
- Implement ONLY task 50: "Create middleware package for CRM Management Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 50 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 50 --mode complete
```
