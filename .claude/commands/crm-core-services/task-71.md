# crm-core-services - Task 71

Execute task 71 for the crm-core-services specification.

## Task Description
Create metrics collection for CRM Management Service
...
## Usage
```
/Task:71-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create metrics collection for CRM Management Service"

```
Use the @spec-task-executor agent to implement task 71: "Create metrics collection for CRM Management Service" for the crm-core-services specification and include all the below context.
...
## Task Details
- Task ID: 71
- Description: Create metrics collection for CRM Management Service
- Leverage: Prometheus Go client library
- Requirements: Performance monitoring

## Instructions
- Implement ONLY task 71: "Create metrics collection for CRM Management Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 71 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 71 --mode complete
```
