# crm-core-services - Task 18

Execute task 18 for the crm-core-services specification.

## Task Description
Create full-text search indexes for CRM Management Service

## Code Reuse
**Leverage existing code**: PostgreSQL full-text search, GIN indexes
...
## Usage
```
/Task:18-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create full-text search indexes for CRM Management Service"

```
Use the @spec-task-executor agent to implement task 18: "Create full-text search indexes for CRM Management Service" for the crm-core-services specification and include all the below context.
...
## Task Details
- Task ID: 18
- Description: Create full-text search indexes for CRM Management Service
- Leverage: PostgreSQL full-text search, GIN indexes
- Requirements: 3.2

## Instructions
- Implement ONLY task 18: "Create full-text search indexes for CRM Management Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 18 --mode complete
```
