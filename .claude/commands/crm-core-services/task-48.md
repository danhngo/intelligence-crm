# crm-core-services - Task 48

Execute task 48 for the crm-core-services specification.

## Task Description
Add rate limiting middleware to User Management Service

## Code Reuse
**Leverage existing code**: Rate limiting libraries, Redis for state storage
...
## Usage
```
/Task:48-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add rate limiting middleware to User Management Service"

```
Use the @spec-task-executor agent to implement task 48: "Add rate limiting middleware to User Management Service" for the crm-core-services specification and include all the below context.
...
## Task Details
- Task ID: 48
- Description: Add rate limiting middleware to User Management Service
- Leverage: Rate limiting libraries, Redis for state storage
- Requirements: 7.3

## Instructions
- Implement ONLY task 48: "Add rate limiting middleware to User Management Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 48 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 48 --mode complete
```
