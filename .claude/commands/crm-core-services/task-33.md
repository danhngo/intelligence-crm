# crm-core-services - Task 33

Execute task 33 for the crm-core-services specification.

## Task Description
Create contact management service layer

## Code Reuse
**Leverage existing code**: Contact repository, validation framework
...
## Usage
```
/Task:33-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create contact management service layer"

```
Use the @spec-task-executor agent to implement task 33: "Create contact management service layer" for the crm-core-services specification and include all the below context.
...
## Task Details
- Task ID: 33
- Description: Create contact management service layer
- Leverage: Contact repository, validation framework
- Requirements: 3.1, 3.4

## Instructions
- Implement ONLY task 33: "Create contact management service layer"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 33 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 33 --mode complete
```
