# crm-core-services - Task 26

Execute task 26 for the crm-core-services specification.

## Task Description
Add role management to User service layer

## Code Reuse
**Leverage existing code**: Permission model, role validation logic
...
## Usage
```
/Task:26-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add role management to User service layer"

```
Use the @spec-task-executor agent to implement task 26: "Add role management to User service layer" for the crm-core-services specification and include all the below context.
...
## Task Details
- Task ID: 26
- Description: Add role management to User service layer
- Leverage: Permission model, role validation logic
- Requirements: 2.1, 2.2, 2.4, 2.5

## Instructions
- Implement ONLY task 26: "Add role management to User service layer"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 26 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 26 --mode complete
```
