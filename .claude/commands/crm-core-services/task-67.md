# crm-core-services - Task 67

Execute task 67 for the crm-core-services specification.

## Task Description
Create Docker Compose for local development

## Code Reuse
**Leverage existing code**: Docker Compose service orchestration
...
## Usage
```
/Task:67-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Docker Compose for local development"

```
Use the @spec-task-executor agent to implement task 67: "Create Docker Compose for local development" for the crm-core-services specification and include all the below context.
...
- Leverage: Docker Compose service orchestration
- Requirements: Development environment

## Instructions
- Implement ONLY task 67: "Create Docker Compose for local development"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 67 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 67 --mode complete
```
