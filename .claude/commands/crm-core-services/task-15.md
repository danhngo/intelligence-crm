# crm-core-services - Task 15

Execute task 15 for the crm-core-services specification.

## Task Description
Create contacts table migration for CRM Management Service

## Code Reuse
**Leverage existing code**: PostgreSQL composite indexes, text search
...
## Usage
```
/Task:15-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create contacts table migration for CRM Management Service"

```
Use the @spec-task-executor agent to implement task 15: "Create contacts table migration for CRM Management Service" for the crm-core-services specification and include all the below context.
...
## Task Details
- Task ID: 15
- Description: Create contacts table migration for CRM Management Service
- Leverage: PostgreSQL composite indexes, text search
- Requirements: 3.1, 6.1

## Instructions
- Implement ONLY task 15: "Create contacts table migration for CRM Management Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 15 --mode complete
```
