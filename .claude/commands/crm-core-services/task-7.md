# crm-core-services - Task 7

Execute task 7 for the crm-core-services specification.

## Task Description
Generate Go code from Protocol Buffer definitions

## Code Reuse
**Leverage existing code**: Protocol Buffer compiler, gRPC code generation
...
## Usage
```
/Task:7-crm-core-services
```

## Instructions

Execute with @spec-task-executor agent the following task: "Generate Go code from Protocol Buffer definitions"

```
Use the @spec-task-executor agent to implement task 7: "Generate Go code from Protocol Buffer definitions" for the crm-core-services specification and include all the below context.
...
- Leverage: Protocol Buffer compiler, gRPC code generation
- Requirements: 7.2

## Instructions
- Implement ONLY task 7: "Generate Go code from Protocol Buffer definitions"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks crm-core-services 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks crm-core-services 7 --mode complete
```
